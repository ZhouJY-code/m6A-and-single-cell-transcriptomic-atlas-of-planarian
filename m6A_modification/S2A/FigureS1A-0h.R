...
control_utr5<-read.table("E:/0h-kd-m6a-utr5",stringsAsFactors=F);
control_cds<-read.table("E:/0h-kd-m6a-cds",stringsAsFactors=F);
control_utr3<-read.table("E:/0h-kd-m6a-utr3",stringsAsFactors=F);
