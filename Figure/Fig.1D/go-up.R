BP<-read.table("E:/up.txt",head=T,stringsAsFactors = F,sep="\t",quote="");
...
barplot(rev(data_pvalue),horiz=T,las=1,cex.names=1,xlim=c(0,30),space=0.3,col="deepskyblue",xlab="-log10(pvalue)",xaxt="n", border="white");
